(gtk_accel_path "<Actions>/terminal-window/new-tab" "<Alt>b")
(gtk_accel_path "<Actions>/terminal-window/close-tab" "<Primary>F4")
...
(gtk_accel_path "<Actions>/terminal-window/move-tab-right" "<Alt><Shift>Right")
